...
export default class DApp {
  ...
  async _openChannel (params) {
    ...
    const bankroller_address = params.open_args.bankroller_address // Eth.acc.address
    ...
    if (!DCLib.checkHashSig(Utils.sha3(channel_id, player_address, bankroller_address, player_deposit, bankroller_deposit, session, ttl_blocks, game_data), signed_args, player_address)) {
